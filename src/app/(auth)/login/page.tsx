...
import PasswordField from './PasswordField'; // PERBAIKAN: Import komponen PasswordField yang baru

// Komponen ini tetap menjadi Server Component, lebih cepat dan aman.
      ...
      <div className="relative w-full max-w-4xl h-auto md:h-[650px] bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col md:flex-row z-10">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12">
            <form action={loginAction} className="w-full text-center">
              ...
              <div className="space-y-4 text-left">
                <input 
                  ...
                  required 
                />
                {/* PERBAIKAN: Menggunakan komponen PasswordField yang diimpor */}
                <PasswordField name="password" placeholder="Password" />
              </div>
              <Link href="#" className="text-sm text-brand-orange hover:underline mt-4 block text-right">Forgot Password?</Link>
              <button type="submit" className="w-full mt-6 bg-brand-orange text-white font-medium py-4 rounded-full hover:bg-brand-orange-hover">
                Login
              </button>
            </form>
          </div>
          ...
          {/* Register Form */}
          <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12">
            <form action={registerAction} className="w-full text-center">
        ...
        {/* Overlay untuk beralih antara Login dan Register */}
