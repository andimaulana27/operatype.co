...
import { UserPencilIcon, KeyIcon, DownloadIcon } from '@/components/icons';

// Mengambil tipe asli dari database.types.ts
type Order = Database['public']['Tables']['orders']['Row'];
type Font = Database['public']['Tables']['fonts']['Row'];

// DIPERBARUI: Mendefinisikan tipe Profile secara manual agar cocok 100%
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mt-4">
                    <p className="text-sm text-gray-500">Password management feature will be here.</p>
                </div>
            </div>
        </div>
