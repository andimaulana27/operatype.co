...
// PERBAIKAN: Menambahkan `paramName` ke dalam definisi tipe props
type FilterDropdownProps = {
  label?: string;
  options: string[];
  paramName: 'category' | 'sort'; // Parameter URL yang akan diubah
};

export default function FilterDropdown({ label, options, paramName }: FilterDropdownProps) {
